...
trait McpAbilityHelperTrait {
	 ...
	 *
	 * @param \BLU_WP_Ability $ability The ability object to check.
	 *
	 * @return bool True if publicly exposed, false otherwise.
	 */
	protected static function is_ability_mcp_public( \BLU_WP_Ability $ability ): bool {
		$meta = $ability->get_meta();
	 ...
	 */
	protected static function get_ability_mcp_type( \BLU_WP_Ability $ability ): string {
		$meta = $ability->get_meta();
