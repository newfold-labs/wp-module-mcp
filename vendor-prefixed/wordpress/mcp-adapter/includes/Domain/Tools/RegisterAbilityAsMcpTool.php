...
use BLU_WP_Ability as WP_Ability;
...
class RegisterAbilityAsMcpTool {
	 ...
	 *
	 * @param \BLU_WP_Ability            $ability    The ability.
	 * @param \Bluehost\Plugin\WP\MCP\Core\McpServer $mcp_server The MCP server.
	 *
	 * @return \Bluehost\Plugin\WP\MCP\Domain\Tools\McpTool|\WP_Error Returns a new instance of McpTool or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \Bluehost\Plugin\WP\MCP\Domain\Tools\McpTool|\WP_Error The validated MCP tool instance or WP_Error if validation fails.
	 */
