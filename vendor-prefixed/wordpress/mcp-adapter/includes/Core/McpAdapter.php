...
final class McpAdapter
{
    ...
    {
        blu_wp_register_ability_category('mcp-adapter', array('label' => 'MCP Adapter', 'description' => 'Abilities for the MCP Adapter'));
    }
    /**
    ...
    private function register_wp_cli_commands(): void
    {
        ...
        \BLU_WP_CLI::add_command('mcp-adapter', McpCommand::class, array('shortdesc' => 'Manage MCP servers via WP-CLI.', 'longdesc' => 'Commands for managing and serving MCP servers, including STDIO transport.'));
    }
}