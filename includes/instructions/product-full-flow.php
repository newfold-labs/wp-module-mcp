...
Based on the product name and any available description, suggest relevant
variation attributes and their terms.
...
Show a complete product summary:
  ...
  ### 📦 Product Summary — Ready to publish?
...
• NEVER call blu/suggest-product-categories, blu/suggest-product-tag, or
  blu/suggest-product-description — these are sub-prompts with their own
  competing instructions that would break this flow. Use the underlying tools
