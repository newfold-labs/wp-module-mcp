...
IMPROVE MODE (product_id is set):
  Call blu/improve-product-description with:
    { "id": {$product_id_safe}, "tone": "[confirmed tone]" }
...
• NEVER call blu/improve-product-description before tone is confirmed.
• NEVER call blu/suggest-product-description — it is a sub-prompt with competing
  instructions that would break this flow.
